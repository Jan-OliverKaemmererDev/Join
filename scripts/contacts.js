...
function initContacts() {
  initSideMenu("contacts"); // Assuming side-menu.js is loaded
  renderContactList();
  checkUser();
}
...
function renderContactList() {
  ...
  contacts.forEach((contact) => {
    ...
    if (firstLetter !== currentLetter) {
      ...
      listContainer.innerHTML += `<div class="separator-line" style="border-bottom: 1px solid #D1D1D1; margin: 0 35px 0 35px; display: none;"></div>`;
    }
...
/**
 * Shows contact details with fly-in animation
...
function showContactDetails(id) {
  ...
  // Highlight selected in list based on ID
...
/**
 * Renders the HTML for the contact details view
