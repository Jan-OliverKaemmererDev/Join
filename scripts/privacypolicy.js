  ...
  if (isPublic || !currentUser || (currentUser && currentUser.isGuest)) {
    ...
    sidebar.innerHTML = `
      ...
      <div class="nav-links">
        ...
        <a href="privacypolicy.html?public=true" class="active guest-nav-link guest-text-only">
          <span>Privacy Policy</span>
        </a>
        <a href="legalnotice.html?public=true" class="guest-nav-link guest-text-only">
...
function addBackButtonListener() {
  const h1Element = document.querySelector(".privacy-policy-container h1");
  if (h1Element) {
